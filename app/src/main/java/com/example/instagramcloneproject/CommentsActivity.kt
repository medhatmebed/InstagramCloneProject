...
import com.example.instagramcloneproject.adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.example.instagramcloneproject.model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.instagramcloneproject.model.Comment::class.java)
